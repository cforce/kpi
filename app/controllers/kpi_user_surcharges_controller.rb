class KpiUserSurchargesController < ApplicationController
    ...
    def add_surcharge
        ...
        @user_surcharge.save if @period_user.check_user_for_surcharge_update? or (@period_user.check_user_for_self_surcharge_update? and KpiSurcharge.find(params[:kpi_user_surcharge][:kpi_surcharge_id]).changable_by_user)
    ...
    def destroy
        ...
        find_user
        @period = @period_user.kpi_calc_period
        @user_surcharge.destroy if @period_user.check_user_for_surcharge_update? or (@period_user.check_user_for_self_surcharge_update? and @user_surcharge.kpi_surcharge.changable_by_user)
