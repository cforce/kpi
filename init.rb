...
Redmine::Plugin.register :kpi do
  ...
  project_module :kpi do
    ...
    permission :manage_kpi_periods, :kpi_calc_periods => [:index, :new, :edit, :close_for_user, :reopen_for_user, :activate, :update, :create, :destroy, :autocomplete_for_user, :autocomplete_for_applied_user, :add_users, :remove_user, :add_inspectors, :remove_inspector, :update_plans, :update_inspectors]
