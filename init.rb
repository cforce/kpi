...
Redmine::Plugin.register :kpi do
  ...
  project_module :kpi do
    ...
    permission :manage_kpi_periods, :kpi_calc_periods => [:index, :new, :edit, :close, :activate, :update, :create, :destroy, :autocomplete_for_user, :add_inspectors, :remove_inspector, :update_plans, :update_inspectors]
